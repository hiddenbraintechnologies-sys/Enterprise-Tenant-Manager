...
export interface RolloutValidationResult {
  allowed: boolean;
  code?: "COUNTRY_NOT_AVAILABLE" | "COUNTRY_SIGNUP_DISABLED" | "BUSINESS_NOT_AVAILABLE_IN_COUNTRY" | "COUNTRY_BILLING_DISABLED" | "COUNTRY_COMING_SOON" | "MODULE_NOT_AVAILABLE" | "FEATURE_NOT_AVAILABLE";
  message?: string;
}
