...
const MODULE_TIER_ACCESS: Record<string, Record<string, "included" | "addon" | "unavailable">> = {
  furniture: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  furniture_manufacturing: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  hrms: { free: "unavailable", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  legal: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  education: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  tourism: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  logistics: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  real_estate: { free: "unavailable", starter: "addon", basic: "addon", pro: "included", enterprise: "included" },
  pg_hostel: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  coworking: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  clinic: { free: "unavailable", starter: "unavailable", basic: "unavailable", pro: "addon", enterprise: "included" },
  salon: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  gym: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  general_service: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  service: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  consulting: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  // Software Services: Free plan excluded, Basic/Pro included (plan-based feature gating)
  software_services: { free: "unavailable", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  marketplace: { free: "unavailable", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  analytics: { free: "unavailable", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  bookings: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  invoices: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  customers: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  services: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  settings: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  onboarding: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
  reseller: { free: "unavailable", starter: "unavailable", basic: "unavailable", pro: "addon", enterprise: "included" },
  portal: { free: "included", starter: "included", basic: "included", pro: "included", enterprise: "included" },
};
...
const TIER_LIMITS: Record<string, { maxUsers: number; maxCustomers: number; apiRateLimit: number }> = {
  ...
  basic: { maxUsers: 3, maxCustomers: 200, apiRateLimit: 1000 }, // India Basic tier
