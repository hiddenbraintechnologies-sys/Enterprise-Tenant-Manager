...
export default function LandingMalaysia() {
  ...
  const businessTypes = [
    ...
    { key: "accommodation", icon: Building2 },
  ...
  return (
    <LandingLayout>
      <Seo
        title="Simple Business Software for Malaysian SMBs | MyBizStream"
        description="Manage projects, invoices, SST, and payments. Start free. Plans from RM49/month. Built for Malaysian businesses."
        canonicalUrl="https://payodsoft.co.uk/my"
      />
      <section className="relative overflow-hidden px-6 py-20 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl" data-testid="text-hero-title">
            {t("landing.malaysia.heroTitle")}
            <span className="block text-primary">{t("landing.malaysia.heroTitleHighlight")}</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            {t("landing.malaysia.heroDescription")}
            <span className="block mt-2">{t("landing.malaysia.heroSubtext")}</span>
          </p>
          <p className="mt-4 text-sm text-muted-foreground">
            {t("landing.malaysia.trustText")}
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button size="lg" asChild data-testid="button-get-started-hero">
              <a href="/register">
                {t("landing.malaysia.getStartedFree")}
                <ArrowRight className="ml-2 h-4 w-4" />
              </a>
            </Button>
            <Button size="lg" variant="outline" asChild data-testid="button-view-pricing">
              <a href="#pricing">{t("landing.malaysia.viewPricing")}</a>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="border-t bg-muted/30 px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-center text-2xl font-semibold sm:text-3xl" data-testid="text-businesses-title">
            {t("landing.malaysia.builtForTitle")}
          </h2>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {businessTypes.map((type) => (
              ...
              >
                ...
                <span className="text-sm font-medium">{t(`landing.malaysia.businessTypes.${type.key}`)}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-center text-2xl font-semibold sm:text-3xl" data-testid="text-features-title">
            {t("landing.malaysia.featuresTitle")}
          </h2>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <span className="font-medium">{t(`landing.malaysia.features.${feature.key}`)}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="pricing" className="border-t bg-muted/30 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-2xl font-semibold sm:text-3xl" data-testid="text-pricing-title">
            {t("landing.malaysia.pricingTitle")}
          </h2>
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            <Card className="relative" data-testid="card-pricing-free">
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full" asChild>
                  <a href="/register">{t("landing.malaysia.getStartedFree")}</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="relative" data-testid="card-pricing-basic">
              <CardHeader className="pb-4">
                ...
                <div className="mt-2">
                  <span className="text-4xl font-bold">RM49</span>
            ...
            <Card className="relative border-primary" data-testid="card-pricing-pro">
              ...
              <CardHeader className="pb-4">
                ...
                <div className="mt-2">
                  <span className="text-4xl font-bold">RM99</span>
                  <span className="text-muted-foreground"> / month</span>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            {t("landing.malaysia.pricingSubtitle")}
          </p>
        </div>
      </section>
      ...
      <section className="border-t bg-muted/30 px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-center text-2xl font-semibold sm:text-3xl" data-testid="text-security-title">
            {t("landing.malaysia.securityTitle")}
          </h2>
