        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <CardContent>
              {projectsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <Link href="/consulting/projects/new">
                ...
                <div className="space-y-4">
                  {projects.map((project) => (
                    <div key={project.id} className="flex items-center justify-between gap-4">
                      <div>
                        <Link href={`/consulting/projects/${project.id}`}>
          ...
          <Card data-testid="card-recent-timesheets">
            <CardHeader className="flex flex-row items-center justify-between gap-4 space-y-0 pb-2">
              ...
              <Link href="/consulting/timesheets">
            ...
            <CardContent>
              {timesheetsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <Link href="/consulting/timesheets/new">
