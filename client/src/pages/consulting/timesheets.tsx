...
const timesheetFormSchema = z.object({
  projectId: z.string().min(1, "Engagement is required"),
...
export default function ConsultingTimesheets() {
  ...
  const { data: timesheetsData, isLoading } = useQuery<TimesheetResponse>({
    queryKey: ["/api/services/consulting/timesheets", { page, limit: 10, status: statusFilter !== "all" ? statusFilter : undefined }],
  });
  ...
  const createTimesheetMutation = useMutation({
    mutationFn: async (data: TimesheetFormValues) => {
      ...
      return apiRequest("POST", "/api/services/consulting/timesheets", payload);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/services/consulting/timesheets"] });
      toast({
        title: "Time logged",
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Log and manage your consulting hours</p>
          </div>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>
                  Record time spent on a client engagement.
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Start logging your consulting hours to track billable time.
                </p>
