...
const features = [
  ...
  { icon: PoundSterling, text: "VAT-ready billing" },
...
export default function LandingUK() {
  return (
    <LandingLayout>
      <Seo
        title="Simple Business Software for UK SMBs | MyBizStream"
        description="Manage projects, invoices, VAT, and payments. Start free. Plans from £9.99/month. Built for UK businesses."
        canonicalUrl="https://payodsoft.co.uk/uk"
      />
      <section className="relative overflow-hidden px-6 py-20 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl" data-testid="text-hero-title">
            ...
            <span className="block text-primary">for UK SMBs</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Manage projects, invoices, VAT compliance, and payments — all in one place.
            <span className="block mt-2">Start free. Upgrade only when you grow.</span>
          </p>
          <p className="mt-4 text-sm text-muted-foreground">
            Trusted by software companies, consultants, and service businesses across the UK.
          </p>
